...
export const projectsData = [
    ...
    github:
      "https://github.com/KestutisRuockus/clothes-e-shop",
    techStack: [
  ...
  },
  {
    ...
    github:
      "https://github.com/KestutisRuockus/TMDB",
    techStack: [
      { name: "React", icon: "fa-brands fa-react", color: "text-blue-400" },
      {
        name: "Tailwind",
      ...
      { name: "Rest-API", icon: "", color: "", imgUrl: "https://img.icons8.com/?size=100&id=55497&format=png&color=000000" },
    ],
  },
  {
    ...
    github:
      "https://github.com/KestutisRuockus/assignment",
    techStack: [
      { name: "JS", icon: "fa-brands fa-js", color: "text-yellow-400" },
      { name: "React", icon: "fa-brands fa-react", color: "text-blue-400" },
      {
